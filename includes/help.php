	...
	array(
		...
		'content' =>
			...
			'<dl>' .
				...
				'<dd>' . \wp_kses( __( 'The post\'s excerpt (uses <code>the_excerpt</code> if that is set). If no excerpt is provided, will truncate at <code>length</code> (optional attribute, default = 400).', 'activitypub' ), array( 'code' => array() ) ) . '</dd>' .
